...
async function refreshRegistrationEnabled() {
...
async function signinCallback(username, password, done) {
...
function providerCallback(provider) {
    return async function (token, refreshToken, profile, done) {
        ...
        // if a user is found, update info and log in
        if (user) {
            try {
                // update user info
