    ...
    3: [function (require, module, exports) {
        ...
        if (v === undefined) {
          ...
          for (var i = 1; i < len; i++) {
            ...
            if (isNimnChar || wasNimnChar) {
              ...
              str += "".concat(chars.boundaryChar).concat(newStr);
            }

            wasNimnChar = isNimnChar;
          }

          return "".concat(chars.arrStart).concat(str).concat(chars.arrEnd);
        }
      };
      ...
      ListType.prototype._decode = function (v, i) {
        if (v[i] === chars.emptyChar) {
          ...
          i = str.index;
          if (str.value !== undefined) currentArr.push(str.value);
          ...
          for (; v[i] !== chars.arrEnd;) {
            ...
            i = itemVal.index;
            if (itemVal.value !== undefined) currentArr.push(itemVal.value);
          }
    ...
    4: [function (require, module, exports) {
      ...
      MapType.prototype._encode = function (v) {
        if (v === undefined) {
          ...
          return "".concat(chars.objStart).concat(str).concat(chars.objEnd);
        }
      };
      ...
      var skipUntilThisObjectEnds = function skipUntilThisObjectEnds(str, from, to) {
        to = to || str.length;
        var count = 0;
        ...
        for (; from < to; from++) {
          if (chars.objStart === str[from]) {
            ...
            if (count === 0) return from;else count--;
          }
        }
    ...
    8: [function (require, module, exports) {
      ...
      VarMapType.prototype._decode = function (v, i) {
        if (v[i] === chars.emptyChar) {
          ...
          i++;
          var currentObj = {}; //get the index of first chars.fieldNameBoundaryChar after i
          ...
          i = str.index;
          if (str.value !== undefined) currentObj[fieldName] = str.value;
          ...
          for (; v[i] !== chars.arrEnd;) {
            ...
            itemVal = this._item._decode(v, i);
            i = itemVal.index;
            if (itemVal.value !== undefined) currentObj[fieldName] = itemVal.value;
          }
