<template>
    <div>
        <h1>Google Maps</h1>
        <v-card>
            <v-card-title class="justify-center cyan darken-1 white--text pa-3">Build Route</v-card-title>
            <v-card-text>
                <v-row no-gutters justify="center" class="mt-5">
                    ...
                    <v-col cols="12" sm="auto" class="text-center">
                        ...
                        <v-icon class="my-3" v-else>mdi-arrow-down-bold-outline</v-icon>
                    </v-col>
                    <v-col cols="12" sm="5">
                ...
                >
                    Distance between
                    <b>{{$refs.from.value}}</b> and
                    <b>{{$refs.to.value}}</b> is
                    <b>{{distance}}</b> km
                </v-alert>
                <div></div>
            </v-card-text>
